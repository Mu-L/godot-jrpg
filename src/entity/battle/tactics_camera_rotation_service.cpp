...
tog::TacticsCameraRotationService::TacticsCameraRotationService(const godot::Ref<tog::TacticsCameraResource>& camera_resource, const godot::Ref<tog::TacticsControlsResource>& control_resource) {
